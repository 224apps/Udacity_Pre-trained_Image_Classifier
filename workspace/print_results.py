...
#            -The CNN model architecture as model wihtin print _results function
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("/n/n Summary for CNN Model Architecture: ", model.upper())
    ...
    #print summary for results_stats
