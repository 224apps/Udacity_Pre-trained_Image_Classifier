...
def calculates_results_stats(results_dic):
    ...
    #set all the stats to zero first
    ...
    #  # of not-a-dog images using images & dog images counts
    ...
    results_stats['pct_correct_dogs'] = (results_stats['#_correct_dogs'] /  results_stats['n_dogs_img']) * 100.0
     #  % correct not-a-dog images by using the conditional statement for when no 'not a dog' images were submitted
